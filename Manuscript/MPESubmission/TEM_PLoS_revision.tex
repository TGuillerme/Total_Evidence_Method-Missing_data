...
\noindent{\bf Data reproducibility and availability.} All the code used in this analysis is available on \href{https://github.com/TGuillerme/Total_Evidence_Method-Missing_data}{\color{blue}{GitHub}} (\href{https://github.com/TGuillerme/Total_Evidence_Method-Missing_data}{    
goo.gl/4djNUf}) with some information on how to use the various functions. Additionally all the simulated data is available on \href{http://figshare.com/articles/Effect_of_missing_data_on_topological_inference_using_a_total_evidence_approach/1306861}{\color{blue}{FigShare}} (dx.doi.org/10.6084/m9.figshare.1306861).

\subsection*{Supporting Information S1: Tree Inference}
\label{S1_Appendix1}
\noindent{\bf Supporting Information S1 Tree Inference.} Supplementary information on the Tree Inference methods. Contains Figure S1.

\subsection*{Supporting Information S2: Tree Comparisons}
\label{S2_Appendix2}
\noindent{\bf Supporting Information S2 Tree Comparisons.} Supplementary information on the Tree Comparison methods.

\subsection*{Supporting Information S3: Additional results}
\label{S3_Appendix3}
\noindent{\bf Supporting Information S3 Additional results.}. Contains Figures S2, S3, S4 and S5 and Tables S1, S2, S3, S4 S5, S6 and S7.
