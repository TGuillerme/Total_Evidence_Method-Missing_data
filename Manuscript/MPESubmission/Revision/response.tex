...
In fact, even if clades are conserved (figure 5), the resolutions within them can be poor to non-existent when data is poor.
In such cases, the fossil taxa are likely to be placed in any of the clades that share the most characters." lines (@@@)
