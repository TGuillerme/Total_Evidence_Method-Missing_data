...
%Add a note but do not change (i.e. to be consistent and keep the parameters the same (5 levels 0/10/25/50/75)) or flip it so that MC becomes NC, the number of characters (100, 90, 75, 50, 25)
