...
% TG: a fair question...
% the tables in Appendix C that the topology distance metrics for Bayesian posterior distribution = Bayesian consensus. But RF<Tr
% Figure 4,Bayesian consensus and posterior overlap up until >25\% missing data.
% How then in comparisons of the distributions are they always so low (Table 1 max prob. of overlapping distributions = 0.11)?
