...
% TO CHECK @@@
% TG: yes definitely. Just doubled check, it might be because the colors where miss labelled and the reviewer miss read the graph (my fault).
...
% TG: maybe add in a non tip-dating analysis?
