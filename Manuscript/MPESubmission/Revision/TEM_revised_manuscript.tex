...
%\hl{Thus, in the present study, we propose a new approach to the missing-data question, focusing on both palaeontological and neontological data (rather than just palaeontological data), using only simulated data and measuring two aspects of topological recovery }\citep[cf.][\hl{measuring respectively only the clades support or the number of shared clades}]{Wiens01102005,pattinsonphylogeny2014}.

% NC: Reading this in full it seems like the last bit repeats what you've already said. I know the reviewer asked for novelty to be spelled out but I think you do that well above here so maybe leave this bit out to avoid repetition.

% NC: You've also cut out the "here we find" sentences. Did the reviewers ask for this? If not why not put them back and mention novelty in there instead subtly.
...
% NC: Do you think we should add to any of these that BC <0.5 = significantly different and BC > 95% is significantly similar? Up to you.
