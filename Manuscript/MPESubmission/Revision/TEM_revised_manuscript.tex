...
Even if clades are conserved (Fig. 5), the resolution within them can be poor to non-existent when a lot of data is missing (i.e. 75\%).
...
Fortunately, although this data is the most difficult to collect, it also has the least influence on whether our simulations recover the ``best'' tree topology (Fig. 6).
