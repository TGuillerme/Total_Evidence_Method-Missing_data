...
Data for living species is unlikely to be missing in this patchy way, instead full molecular data with the complete absence of morphological data are likely }\citep{GuillermeCooperMissing}.
\hl{Finally, }\cite{manosphylogeny2007}\hl{ and }\cite{pattinsonphylogeny2014}\hl{ mainly focused on how missing data in fossil taxa affects the placement of fossils, ignoring the effects of missing data in living species.}
...
Thus understanding the sensitivity of topology to missing data are important for assessing the accuracy of tree estimation in the Total Evidence framework. To our knowledge, this question has never been formally assessed.
