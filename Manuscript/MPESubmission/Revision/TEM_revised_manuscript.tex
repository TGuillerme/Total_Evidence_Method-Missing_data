...
Not that the $N_C$ parameter states can be seen in the same way as the $M_L$ and $M_F$ ones: the first state (100 characters) corresponds to 0\% less characters than the ``complete'' matrix, the second (90 characters), corresponds to 10\% less than the ``complete'' matrix, etc.
