...
Ignoring fossil taxa may lead to misinterpretation of macroevolutionary patterns and processes such as the timing of diversification events \citep[e.g.][]{pyrondivergence2011}, relationships among lineages (e.g. \citealp{manosphylogeny2007}) or niche occupancy (e.g. \citealp{pearmanniche2008}).
...
However, to do this we need to be able to place living and fossil taxa into the same phylogenies; a task that remains difficult despite recent methodological developments (e.g. \citealp{pyrondivergence2011,ronquista2012,BEASTmaster}).
...
There have been great improvements in the theory and application of these two approaches (e.g. \citealp{bapsta2013,stadlerdating2013,heaththe2013}) as well as much debate about the ``best" approach to use (e.g. \citealp{spencerefficacy2013,wrightbayesian2014}).
...
This approach treats every taxon as a tip in the phylogeny, uses the occurrence age of the fossils to time calibrate the phylogeny (known as tip-dating \citealp{ronquista2012}), and allows the use of probabilistic methods for estimating phylogenetic uncertainty \citep{ronquista2012}.
Total Evidence methods is becoming an increasingly popular way of adding fossil taxa to phylogenies (e.g. \citealp{pyrondivergence2011,ronquista2012,schragocombining2013,slaterphylogenetic2013,beckancient2014}).
