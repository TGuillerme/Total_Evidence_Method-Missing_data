...
Data for living species is unlikely to be missing in this patchy way, instead full molecular data with the complete absence of morphological data is likely }\citep{GuillermeCooperMissing}.
\hl{Finally, }\cite{manosphylogeny2007,pattinsonphylogeny2014}\hl{ mainly focused on how missing data in fossil taxa affects the placement of fossils, ignoring the effects of missing data in living species.}
...
This is an advance on previous studies because we use large-scale simulations and analyse the effect of three distinct aspect of missing data thus focusing on both neontological and paleontological parts of the matrix.
...
\hl{TThis missing data parameter represents the completeness of the fossil record.
