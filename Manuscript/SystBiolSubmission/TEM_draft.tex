...
\begin{figure}[!htbp]
\centering
    \includegraphics[width=1\textwidth]{AllMethods-RF+Tr-colour.pdf}
\caption{ }
\end{figure}
...
\begin{figure}[!htbp]
\centering
    \includegraphics[width=1\textwidth]{ML+Baycon-AllParam-RF+Tr-BW.pdf}
\caption{ }
\end{figure}
...
\begin{figure}
\centering
    \includegraphics[width=1\textwidth]{PairwiseComp-Baycon-RF+Tr-colour.png}
\caption{ }
\end{figure} 
