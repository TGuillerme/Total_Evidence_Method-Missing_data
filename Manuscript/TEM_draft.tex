...
\label{Fig_Results_1} %Differences within a subset of parameters and between methods
\end{figure}
...
\label{Fig_Results_2} %Differences between all the parameters and between two methods (ML vs BC)
\end{figure}
...
\label{Fig_Results_4} %Comparisons between methods, both in RF and Triplets.(method differences)
\end{figure}
