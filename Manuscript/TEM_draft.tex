...
\label{Fig_Global-single}
\end{figure}
%Differences between the parameters and between the methods (ML vs BC)


\begin{figure} 
\centering
    \includegraphics[width=1\textwidth]{Figures/BW/Global-Bootstrap+Treeset-RF+Tr-small.pdf}
...
\label{Fig_Global-treesets}
\end{figure}
%Differences between the parameters and between the methods (BS vs TS)
...
\label{Fig_Parameter-Method}
\end{figure}
%Differences within the parameters, not between
