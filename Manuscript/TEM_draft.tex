...
Even though the RPBTC is dependent on 1000 random tree drawings, the output tree comparison score (i.e. the mode) is still significant not different between independent replicates (100 replicates of 1000 RPBTC each - see \hyperref[supplementaries]{supplementaries}, table ~\ref{RPBTC_testing})
%
%
%
