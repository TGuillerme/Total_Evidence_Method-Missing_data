...
%TG: I swapped the results to be consistent, ML and MC first and then Bayesian % NC: Cool
...
% NC: Cool this is better and closer to what Gavin meant. I've condensed it a bit
...
% TG: And after the literature review for the next paper (missing living in mammals) on community structure & Co. I start to get where you guys are comming for ;). % NC :P
...
%and because they illustrate two different aspects of tree topology (see Discussion). TG: ok I've fixed that towards: "as said above, they describe two different things but also they're cool because we know how they behave and the code is available to calculate them." - a bit more honest. % NC: This is better
...
% NC: OK let's discuss tomorrow. I don't understand
