...
Therefore, we advocate that an effort should be made in collecting all the available morphological information for living taxa in order to properly run Total Evidence analysis. %yep, we need data from living taxa.
