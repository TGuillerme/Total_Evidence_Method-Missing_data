...
% TG: a note about the "correct" topology regarding your comment just after the discussion header: should I replace "correct" by "best" since that's how we're calling the "best" tree anyway (all in quotes)
