...
mpirun -np 8 mb ${folder}${n}/${chain}${n}_L00F00C00.hor.cmd ;
mpirun -np 8 mb ${folder}${n}/${chain}${n}_L00F00C00.ver.cmd ;
mpirun -np 8 mb ${folder}${n}/${chain}${n}_L00F00C00.cor.cmd ;" | sed 's/\/\#!/\#!/g' > ${chain}${n}.job
