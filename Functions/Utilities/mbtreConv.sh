...
##########################
#Concatenate and convert MrBayes consensus trees (*.con.tre) into a unique <CHAIN>_trees.tre file with species names, branch length and posterior probabilities as node labels. I.e. concatenates a list of con.tre files into a single file with the same species and every tree.
#version: 1.0
#----
